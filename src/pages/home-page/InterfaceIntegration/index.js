...
const hasTrackedRef = useRef(false);
    const videoId = "InterfaceVideo";
       useWatchTime(videoRef, "InterfaceVideo", viewState === "video");
                    ...
                    <div className="thumbnails grid relative grid-cols-1 gap-8 items-center mx-auto">
                        ...
                        >
                            <div className="relative mx-auto w-full">
                                <img
                                    src="https://cpb-uglsolution-videos.s3-accelerate.amazonaws.com/Interface%26IntegrationThumb.jpg"
                                    alt="Thumbnail interface & integration"
