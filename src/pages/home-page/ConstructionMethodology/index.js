                ...
                <div className="videoView h-full relative flex flex-col justify-center">
                    <div className="relative min-[1680px]:w-[65%] min-[1200px]:w-[55%] w-full mx-auto">
                        ...
                        ref={videoRef}
                            ...
                            src="https://cpb-uglsolution-videos.s3-accelerate.amazonaws.com/Construction_Sequence_feb2025.mp4"
                            controls
                            onClick={() => setIsPlaying(false)}
                            poster="https://cpb-uglsolution-videos.s3-accelerate.amazonaws.com/Construction_Sequence_Thumbnail.jpg"
                        />
                        {!isPlaying && (
